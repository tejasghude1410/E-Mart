...
import signin from '../../Components/Assets/signin.jpg';
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="loginfooter">
                                    <button className="btnlogin" type="submit" disabled={isSubmitting}>
                                        {isSubmitting ? (<div className="globalbtnspin"></div>) : ("Sign in")}
                                    </button>
                                    <button className="btnlogin" disabled={isSubmitting} onClick={() => navigate('SignUp')}>
                                        Sign Up
                                    </button>
                                </div>
                            </form>
