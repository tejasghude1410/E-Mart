    ...
    <div className="signup-container">
      <Formik
        initialValues={{ 
          ...
          custPassword: "", 
          confirm_password: "", 
          cardHolder: "false" // defaulting to string "false"
        }}
        onSubmit={async (values, { setSubmitting }) => {
          try {
            ...
            const preparedValues = {
              ...values,
              cardHolder: values.cardHolder === "true", // Convert "true" to true and "false" to false
            };
            delete preparedValues.confirm_password; // Remove confirm_password
        ...
        validationSchema={Yup.object().shape({
          ...
          cardHolder: Yup.string()
            .required("Please indicate if the person is a card holder.")
            .matches(/^(true|false)$/, "Must be true or false"), // Ensure it's either "true" or "false"
        })}
      >
        {({ values, touched, errors, isSubmitting, handleChange, handleBlur, handleSubmit }) => (
          <div className="signup-form">
